...
#if UNITY_EDITOR
public class AddObjectGenerationPanel : EditorWindow
{
    ...
    {
        string file_path = Application.dataPath + "/AWObjectGeneration.xml";
        ...
        prefabXML.InnerText = Application.dataPath + "/Ressources/" + prefab.name + ".prefab";
        //
        File.Copy(Application.dataPath + "/Prefabs/" + prefab.name + ".prefab", Application.dataPath + "/Ressources/" + prefab.name + ".prefab");
        //
